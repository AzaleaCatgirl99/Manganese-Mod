...
public:
	...
	static void AddNewCheckbox(UIControl_MultiList* _this, const wchar_t* label, int id, bool defaultValue);
};
...
CREATE_FUNC(UIControl_MultiList_AddNewCheckbox, 0x1407c5340, void, UIControl_MultiList* _this, const wchar_t* label, int id, bool defaultValue);
//CREATE_FUNC(UIControl_MultiList_AddNewLabel, 0x1407c5340, void, UIControl_MultiList* _this, const std::wstring& label, int id, bool defaultValue);