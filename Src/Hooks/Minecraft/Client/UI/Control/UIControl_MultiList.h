...
public:
	...
	static void AddNewCheckbox(UIControl_MultiList* _this, const std::wstring& checkboxName, int id);
};
...
CREATE_FUNC(UIControl_MultiList_AddNewCheckbox, 0x14069F070, void, UIControl_MultiList* _this, const std::wstring& checkboxName, int id);
